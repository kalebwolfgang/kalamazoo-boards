...
foreach ($f in $files) {
    ...
    if ($c -notmatch 'href="calendar\.html"') {
        $c = $c.Replace(
            ...
            '<a class="nav-link" href="calendar.html">Calendar</a>' + "`r`n            " + '<a class="nav-link" href="calendar.html">Calendar</a>
            <a class="nav-link" href="index.html">All Boards</a>'
        )
        $c = $c.Replace(
            '<a class="nav-secondary-link" href="calendar.html">Calendar</a>
        <a class="nav-secondary-link" href="index.html">All Boards</a>',
            '<a class="nav-secondary-link" href="calendar.html">Calendar</a>' + "`r`n        " + '<a class="nav-secondary-link" href="calendar.html">Calendar</a>
        <a class="nav-secondary-link" href="index.html">All Boards</a>'
        )
    }
